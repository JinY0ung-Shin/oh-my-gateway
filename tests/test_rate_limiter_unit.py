...
class TestGetRateLimitForEndpoint:
    ...
    def _reload_modules(self):
        """Reload constants and rate_limiter to pick up env var changes."""
        import importlib
    ...
    def test_debug_endpoint_default(self):
        ...
        with patch.dict(os.environ, env_copy, clear=True):
            ...
            result = get_rate_limit_for_endpoint("debug")
    ...
    def test_health_endpoint_default(self):
        ...
        with patch.dict(os.environ, env_copy, clear=True):
            ...
            result = get_rate_limit_for_endpoint("health")
    ...
    def test_session_endpoint_default(self):
        ...
        with patch.dict(os.environ, env_copy, clear=True):
            ...
            result = get_rate_limit_for_endpoint("session")
    ...
    def test_auth_endpoint_default(self):
        ...
        with patch.dict(os.environ, env_copy, clear=True):
            ...
            result = get_rate_limit_for_endpoint("auth")
            assert result == "10/minute"
    ...
    def test_general_endpoint_default(self):
        ...
        with patch.dict(os.environ, env_copy, clear=True):
            ...
            result = get_rate_limit_for_endpoint("general")
            assert result == "30/minute"
    ...
    def test_unknown_endpoint_uses_general_default(self):
        ...
        with patch.dict(os.environ, env_copy, clear=True):
            ...
            result = get_rate_limit_for_endpoint("unknown_endpoint")
            assert result == "30/minute"
